...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/cloudyzeeshan',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'My Portfolio',
              href: 'https://zh-my-portfolio.vercel.app/',
            },
            {
              label: '(X)Twitter',
              href: 'https://x.com/Taimoor80881706',
            },
          ],
        },
        {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Physical AI Textbook. Built with Zeeshan Haider.`,
    },
    prism: {
